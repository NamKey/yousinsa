...
class AuthorizeAspectTest {
	...
	private AcceptStoreRequestDto acceptStoreRequestDto;
	...
	public void authorizeByAop() {
		...
		// when
		ResponseEntity<RequestStoreDtoResponse> proxyAcceptResponse = proxy.alterStoreStatus(
			validStoreId,
			acceptStoreRequestDto
		);
	...
	public void authorizeByAopNotPermittedRoleOwner() {
		...
		Assertions.assertThatThrownBy(() -> {
				proxy.alterStoreStatus(validStoreId, acceptStoreRequestDto);
			})
